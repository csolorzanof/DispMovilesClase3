 ...
 * Use the [ContadorFragment.newInstance] factory method to
...
class ContadorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val txtContador = view.findViewById<TextView>(R.id.txtContador)
        view.findViewById<Button>(R.id.btnMenos).setOnClickListener {
            var valor = txtContador.text.toString().toInt()
            if(valor > 0)
                valor--
            txtContador.text=valor.toString()
        }
